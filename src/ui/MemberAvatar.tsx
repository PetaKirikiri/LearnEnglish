...
export default function MemberAvatar({ name, url, size = 36 }: { name: string; url?: string | null; size?: number }) {
  ...
  return <span aria-hidden="true" className="inline-flex shrink-0 items-center justify-center overflow-hidden rounded-full bg-[#e8eadf] text-sm font-semibold text-[#526044]" style={{ width: size, height: size }}>
