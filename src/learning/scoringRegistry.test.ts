...
it('registers every current question and its exact answer with server scoring', () => {
  const sql = ['20260914081000_current_scoring_keys.sql', '20260921170000_exam_practice.sql', '20260921180000_exam_audit.sql', '20260921220000_exam_depth.sql', '20260922070100_plain_reading_questions.sql', '20260922073100_plain_vocabulary_questions.sql', '20260922090100_question_level_review.sql'].map(file => readFileSync(`supabase/migrations/${file}`, 'utf8')).join('\n')
