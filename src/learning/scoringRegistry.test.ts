...
it('registers every current question and its exact answer with server scoring', () => {
  const sql = ['20260914081000_current_scoring_keys.sql', '20260921170000_exam_practice.sql', '20260921180000_exam_audit.sql'].map(file => readFileSync(`supabase/migrations/${file}`, 'utf8')).join('\n')
