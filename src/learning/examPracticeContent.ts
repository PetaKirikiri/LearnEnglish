...
const dialogueRows: [string,number,string,string,string[],string][] = [
 ...
 ['two-items',36,'There are two things in the room: a bed _____ a dresser.','and',['but','or','because'],'โจทย์บอกว่ามีของสองอย่างร่วมกัน ใช้ and เชื่อม bed กับ dresser'],
...
const readingRows: [string,string,number,string,string,string,string[],string][] = [
 ['houses-main','different-houses',39,'Houses, apartments, and farms are not the only places where people live. Some people live in really different houses!','What is this text about?','Different kinds of homes.',['Ways to get to school.','A school day.','How to cook dinner.'],'ข้อความพูดถึงสถานที่อยู่อาศัยหลายแบบ หาใจความที่ครอบคลุมตัวอย่างทั้งหมด ไม่เลือกเพียงรายละเอียดเดียว'],
 ...
 ['houses-treehouses','different-houses',39,'There are three treehouses there that you can stay in. They are near the beautiful Diamond Beach.','How many treehouses can you stay in?','Three.',['One.','Two.','Six.'],'How many ถามจำนวน มองหาตัวเลขหรือคำบอกจำนวนที่ขยาย treehouses'],
 ['houses-rocks','different-houses',39,'Cappadocia has many cave houses. People made them inside large rocks. The rocks in Cappadocia are kind of soft.','In “People made them”, what does “them” mean?','Cave houses.',['People.','Treehouses.','Photographs.'],'them เป็นกรรมพหูพจน์ ย้อนดูสิ่งที่คนสร้างในประโยคก่อนหน้า คือ cave houses'],
 ...
 ['train-support','a-train-above-you',51,'The tracks are supported by massive steel columns.','What holds up the train tracks?','Steel columns.',['Doors.','Cave walls.','Trees.'],'are supported by บอกว่าสิ่งใดรองรับราง คำหลัง by เป็นผู้ทำหน้าที่รองรับ'],
 ['train-platform','a-train-above-you',51,'Riders climb stairs or take an elevator from the sidewalk to the platform.','How can you get to the platform?','By stairs or elevator.',['By plane or taxi.','By swimming.','By bicycle only.'],'How ถามวิธี ข้อความให้สองวิธีเชื่อมด้วย or คือขึ้นบันไดหรือใช้ลิฟต์'],
 ['train-price','a-train-above-you',51,'A train ticket costs less than a taxi ride.','Which costs less?','A train ticket.',['A taxi ride.','They cost the same.','We do not know.'],'less than หมายถึงน้อยกว่า สิ่งที่อยู่ก่อน costs less มีราคาถูกกว่าสิ่งหลัง than'],
 ...
 ['houses-percent','different-houses',39,'Fifty-six percent of the world’s people live in cities. Many people in the city live in apartments.','What percent of people live in cities?','Fifty-six percent.',['Six percent.','Fifty percent.','Sixty-five percent.'],'What percent ถามร้อยละ อ่านจำนวน fifty-six percent ที่อยู่หน้าคำว่า people'],
 ...
 ['houses-water','different-houses',39,'The Drina River house is not a house beside the water. It’s a house over the water!','Where is the house?','The house is over the water.',['The house is beside the water.','The house is under the water.','The house is inside a cave.'],'อ่าน not ให้ครบ ข้อความปฏิเสธ beside แล้วแก้เป็น over อย่าเลือกเพียงคำที่พบในเรื่อง'],
 ['houses-bali','different-houses',39,'In Bali, Indonesia, you can try living in the famous Rumah Pohon Treehouse. There are three treehouses there that you can stay in. They are near the beautiful Diamond Beach.','Where are these treehouses?','In Bali, Indonesia.',['In Serbia.','In Cappadocia, Turkey.','In Chicago.'],'these treehouses อ้างถึงบ้านต้นไม้ที่กล่าวถึงใน Bali, Indonesia'],
 ['houses-soft','different-houses',39,'The rocks in Cappadocia are kind of soft. People have lived in these cave homes for thousands of years.','Which things are soft?','The rocks.',['The people.','The trains.','The water.'],'หาเจ้าของลักษณะ soft จากประธานในประโยค คือ The rocks'],
 ...
 ['train-noise','a-train-above-you',51,'The sun is shining, but you think you hear thunder. Look up! A train is passing over your head!','What is making the sound like thunder?','A passing train.',['Rain.','A taxi driver.','A door closing.'],'อ่านประโยคต่อจากคำว่า thunder เสียงที่คิดว่าเป็นฟ้าร้องมาจากรถไฟที่กำลังผ่านด้านบน'],
 ['train-traffic','a-train-above-you',51,'On the ground, cars and buses start and stop in traffic. Above them, trains are moving from station to station with no traffic jams.','Cars stop in traffic. Why can the trains keep moving?','They run above the street traffic.',['They drive on the same road.','They wait behind the buses.','They stop at every car.'],'เปรียบเทียบ On the ground กับ Above them รถไฟอยู่ด้านบนและไม่มีรถติดเหมือนถนน'],
 ['train-loop','a-train-above-you',51,'The tracks make a loop around the city center and then run out in all directions to the different parts of the city.','The tracks go around the city center. Where do they go next?','To different parts of the city.',['Only to one house.','Into the river.','Only under the sidewalk.'],'and then บอกลำดับต่อมา รางแยกออกไปยังส่วนต่าง ๆ ของเมือง'],
 ['train-sequence','a-train-above-you',51,'They buy a ticket, go through a gate, and wait for the next train to take them where they want to go.','What do riders do next after they buy a ticket?','Go through a gate.',['Buy another ticket.','Drive a taxi.','Go to sleep.'],'เรียงลำดับจากข้อความ: buy a ticket → go through a gate → wait'],
 ...
 ['train-students','a-train-above-you',51,'Students can do their homework or play a game on their phone. People read or talk. Some even go to sleep and wake up when they reach their stop.','What can students do on the train?','Do their homework.',['Drive the train.','Cook dinner.','Clean the tracks.'],'คำถามถามสิ่งที่ข้อความกล่าวถึงจริง เลือก do their homework ไม่ใช้กิจกรรมที่เพียงแต่เป็นไปได้'],
 ['train-some','a-train-above-you',51,'Some trains run all the time, day or night.','What does the text say about trains at night?','Some trains run day and night.',['All trains stop at night.','All trains run every ten minutes all night.','No trains run on weekends.'],'Some หมายถึงบางขบวน ไม่ใช่ทุกขบวน อย่าขยายความเป็น all หรือ no'],
 ['train-main','a-train-above-you',51,'While drivers on the ground are stuck in traffic, riders on the L are on their way. Students can do their homework or play a game on their phone. People read or talk. Some even go to sleep and wake up when they reach their stop.','Why take the train when cars are stuck in traffic?','You can keep travelling and do your homework.',['You have to drive the train.','It always costs more than a taxi.','You cannot read on the train.'],'ใจความรวมคือผู้โดยสารยังเดินทางได้เมื่อถนนรถติดและทำกิจกรรมอื่นได้ ไม่ใช่เลือกแค่คำเดียวจากเรื่อง'],
