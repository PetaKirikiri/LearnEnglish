...
const dialoguePractice: Row[] = [
 ...
 ['two-items','There are two things in the kitchen: a stove _____ a sink.','and','or','but','because','two things บอกว่ามีสองสิ่ง ใช้ and เชื่อม stove กับ sink'],
...
const dialogueAssessment: Row[] = [
 ...
 ['two-items','The room has two seats: a couch _____ an armchair.','and','or','but','because','two seats บอกว่ามีที่นั่งสองชิ้น ใช้ and เชื่อม couch กับ armchair'],
...
const readingPractice: Row[] = [
 ["houses-main", "What is this part about?", "Different homes.", "Travelling by train.", "Cooking at home.", "A school day.", "ดูใจความที่ครอบคลุมบ้านและที่อยู่อาศัยหลายรูปแบบ"],
 ...
 ["train-name", "What is the L?", "An overhead train.", "A taxi.", "A cave house.", "A beach.", "the overhead train is called the L บอกชื่อรถไฟ"],
 ["train-support", "What are the columns made of?", "Steel.", "Wood.", "Glass.", "Paper.", "steel ขยาย columns บอกวัสดุของเสาที่รองรับราง"],
 ["train-platform", "Where do you go when you take the stairs or elevator?", "The platform.", "Inside a taxi.", "Diamond Beach.", "A treehouse.", "from ... to ... บอกจุดเริ่มต้นและปลายทาง ปลายทางคือ platform"],
 ...
 ["train-frequency", "When do trains come more often?", "At busy times.", "At night.", "On weekends.", "In the morning only.", "not as often ตอนกลางคืนและสุดสัปดาห์แปลว่าช่วงคนมากรถไฟถี่กว่า"],
 ...
 ["houses-soft", "What are the rocks in Cappadocia like?", "They are kind of soft.", "They are made of steel.", "They are under the water.", "They are train tracks.", "The rocks ... are kind of soft บอกลักษณะหิน"],
 ["houses-years", "Have people lived in these cave homes for a long time?", "Yes, for thousands of years.", "No, for only one day.", "No, for only one week.", "No one lives in the caves.", "for thousands of years หมายถึงอาศัยมาหลายพันปี เป็นเวลานาน จึงตอบ Yes"],
 ["train-noise", "Why should you look up?", "A train is passing above you.", "A taxi is under the road.", "It is raining.", "A bus is in a cave.", "Look up ตามด้วยรถไฟผ่านเหนือหัว เป็นเหตุให้มองขึ้น"],
 ...
 ['train-loop','What shape do the tracks make around the city center?','A loop.','Stairs.','A wall.','A roof.','make a loop around บอกรูปร่างเส้นทางวนรอบ'],
 ["train-sequence", "You are on the platform. What do you do first?", "Buy a ticket.", "Wait for the next train.", "Go through the gate.", "Reach their stop.", "รายการการกระทำเรียง buy a ticket ก่อน go through a gate และ wait"],
 ["train-busy", "At busy times, how many minutes are there between trains?", "Ten minutes.", "Two minutes.", "Thirty minutes.", "Sixty minutes.", "every ten minutes คือช่วงห่างสิบนาที"],
 ...
 ["train-some", "How many trains run all day and night?", "Some trains.", "All trains.", "No trains.", "Only one train.", "Some trains หมายถึงรถไฟบางขบวน ไม่ใช่ all trains ที่แปลว่าทุกขบวน"],
...
const readingAssessment: Row[] = [
 ...
 ["houses-serbia", "Where can you visit the Drina River house?", "Serbia.", "Indonesia.", "Turkey.", "Japan.", "ตามชื่อบ้าน Drina River house ไปยัง This house is in Serbia"],
 ...
 ["houses-rocks", "Where did people make homes in Cappadocia?", "Inside rocks.", "Inside trains.", "Above the sea.", "In trees.", "made them inside large rocks: them คือบ้านถ้ำ ไม่ใช่ต้นไม้"],
 ...
 ["train-support", "What do the steel columns do?", "They hold up the tracks.", "They sell train tickets.", "They drive the taxis.", "They make food.", "supported by บอกหน้าที่รองรับราง ไม่ใช่หน้าที่ขายตั๋ว"],
 ...
 ["train-price", "Which ride costs less, the train or the taxi?", "The train.", "The taxi.", "Both are free.", "Both have the same price.", "less than หมายถึงน้อยกว่า รถไฟจึงถูกกว่าแท็กซี่ตามข้อความ"],
 ["train-frequency", "Trains come less often on weekends. Is this true?", "Yes. They come less often.", "No. They come more often.", "They come every ten seconds.", "There are no trains on weekends.", "not ... as often หมายถึงมาน้อยครั้งกว่าในช่วงที่มีคนมาก ข้อความนี้จึงเป็นจริง ไม่ได้แปลว่าไม่มีรถไฟเลย"],
 ["houses-percent", "In cities, _____ people live in apartments.", "many", "all", "no", "two", "Many หมายถึงจำนวนมาก ไม่ใช่ทุกคน"],
 ...
 ["houses-bali", "What kind of home can you stay in near Diamond Beach?", "A treehouse.", "A cave house.", "A home on a train.", "A home under the sea.", "อ่านข้อความเกี่ยวกับ Bali: บ้านที่อยู่ใกล้ Diamond Beach คือ treehouses"],
 ...
 ["houses-years", "How many years have people lived in these cave homes?", "Thousands of years.", "One night.", "A few minutes.", "One school day.", "for thousands of years ระบุระยะเวลาอย่างชัดเจน"],
 ...
 ["train-traffic", "The cars are on the road. Where are the trains?", "Above the cars.", "Behind every car.", "Inside the buses.", "On the same road.", "Above them บอกระดับของรางแยกจากรถที่ติดบนพื้นถนน"],
 ["train-loop", "Do the tracks go to other parts of the city?", "Yes. They go to other parts of the city.", "No. They only go around the center.", "No. They only go to the river.", "No. They only go inside houses.", "and then run out in all directions แสดงว่าไปส่วนอื่นต่อจากวงรอบ"],
 ...
 ["train-busy", "How often do trains come when it is busy?", "Every ten minutes.", "Once a year.", "Every ten days.", "Once a month.", "as often as every ten minutes บอกความถี่ที่มีได้ ไม่ใช่รับรองทุกเที่ยว"],
 ...
 ["train-main", "Why is the train a good choice when the roads are busy?", "You can keep moving and read or rest.", "You must stop at every car.", "You must drive the train.", "You cannot do homework.", "สรุปทั้งการเดินทางขณะถนนติดและกิจกรรมของผู้โดยสาร"],
]
