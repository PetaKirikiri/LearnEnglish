...
Unrated words have no selected confidence option and say “ยังไม่ประเมิน”. Every unselected emblem is neutral; only the chosen score lights up. The five power indicators describe confidence choices, not word rarity tiers. Never assign a default high rating or use a permanent gold highlight on the highest option.
