...
for(let round=0;round<80;round++) for(const q of createPracticeRound(round,memory)) {
 ...
 if(seen.size===examPracticeQuestions.length&&firstCompleteRound===null) firstCompleteRound=round+1
}
